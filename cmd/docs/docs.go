...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.CreateSubscriptionInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.UpdateSubscriptionInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "models.CreateSubscriptionInput": {
            "type": "object",
            "properties": {
                "end_date": {
                    "type": "string",
        ...
        "models.Subscription": {
            ...
            "properties": {
                ...
                "price": {
                    "description": "в рублях, целое число",
                    "type": "integer"
                },
                "service_name": {
                    "type": "string"
                ...
                "start_date": {
                    "description": "месяц и год, например 07-2025",
                    "type": "string"
                },
                "user_id": {
                    "type": "string"
        ...
        "models.UpdateSubscriptionInput": {
            "type": "object",
            "properties": {
                "end_date": {
                    "type": "string",
